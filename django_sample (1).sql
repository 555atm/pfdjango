...
(1, 'pbkdf2_sha256$260000$62Fcm9JK3JVLCapAdqoqok$XRsHxTUPfYDCWgaVZu1TsqpZj9LhWhtPJ+xR8A+wR4M=', '2023-05-15 16:19:25.995162', 1, 'admin', '', '', '', 1, 1, '2023-04-04 15:12:25.355602'),
(2, 'pbkdf2_sha256$260000$7gPTYjm4ANgEhFkmOk4Twm$Vc/8pB3mGE4wMOWB4KjVD4l1GIXF5WLphAXuJN70apM=', '2023-05-12 05:41:48.489951', 0, 'test01', '', '', '', 0, 1, '2023-04-05 03:53:17.512315');
...
(30, 'myhaiku', '0002_auto_20230516_0053', '2023-05-15 15:53:46.528187'),
(31, 'myhaiku', '0003_alter_haiku_naka_random', '2023-05-15 15:54:23.532081'),
(32, 'myhaiku', '0004_auto_20230516_1139', '2023-05-16 02:39:46.685099');
...
('c5w92rcg5v2egxd9ad72qcfys9z994q8', '.eJxdjMsOgyAQRf-FtTESEKzL7vsNZIYBoSokPlZN_73a2KS6Pfec-2IG1iWYdXaTicRaxlnxzxBs79I-0BNSl0ub0zJFLHelPNa5fGRyw_1wTwcB5rDXyhIqvJHWsoFaA1S88TX3KAi8qEA7h1YrgUpIiSCo8RqlqDkBVrXcTnsYo5kgUR5Zm9ZhKFiCHi5oDnHMF_Ytu3yqNs-GeK5-yvsDLhBfrQ:1pylBm:kRHb6XAmrTRLWyZo6I4diSyy-u_y7fva0OUdv5CHxB4', '2023-05-30 03:17:26.438026');
...
CREATE TABLE `myhaiku_haiku` (
  `id` bigint(20) NOT NULL,
  `kami_go` varchar(64) COLLATE utf8mb4_bin NOT NULL,
  `naka_shichi` varchar(64) COLLATE utf8mb4_bin NOT NULL,
  `shimo_go` varchar(64) COLLATE utf8mb4_bin NOT NULL,
  `kami_random` longtext COLLATE utf8mb4_bin,
  `naka_random` longtext COLLATE utf8mb4_bin,
  `shimo_random` longtext COLLATE utf8mb4_bin,
  `created_at` datetime(6) NOT NULL,
  `updated_at` datetime(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
(9, '星', '星は英語で？', 'stan', 'start', 'star', 'star', '2023-05-16 01:32:33.035656', '2023-05-16 01:32:33.035693', 1);
